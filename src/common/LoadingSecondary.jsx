...
export default function LoadingSecondary({ width, height }) {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" width={width} height={height} viewBox="0 0 256 256" space="preserve">
        <defs></defs>
        <g
